 ...
 @section('content')
     <div class="row">
         <div class="col-lg-12 margin-tb">
             ...
             <div class="pull-right">
                 <a class="btn btn-success" href="{{ route('daftar-siswa.create') }}"> Tambah Akun Pendaftar</a>
     ...
     <table class="table-bordered" width="1000px">
         ...
         <tr>
             ...
             <td>{{ $user->decrypt }}</td>
             <td width="250px">
                <form action="{{ route('daftar-siswa.destroy',$user->id) }}" method="POST">
                    {{-- <a class="btn btn-info" href="{{ route('daftar-siswa.show',$user->id) }}"><i class="fas fa-clipboard-list text-gray-100"></i></a> --}}
    
                    <a class="btn btn-primary" href="{{ route('daftar-siswa.edit',$user->id) }}"><i class="fas fa-edit text-gray-100"></a>
