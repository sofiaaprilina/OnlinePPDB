        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body p-0">
                ...
                <div class="row">
                    ...
                    <br>
                        <img src="{{asset('images/log-register.png')}}" style="display:block; margin:auto;width:420px;height:420px;">
                    </div>
                    <div class="col-lg-7">
                        <div class="p-5">
                                ...
                                <form method="POST" action="{{ route('register') }}" class="user">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user @error('name') is-invalid @enderror" name="name" 
                                            value="{{ old('name') }}" required autocomplete="name" autofocus id="name" placeholder="Name">
                                        @error('name')
