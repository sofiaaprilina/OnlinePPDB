...
<head>
    ...
    <link href="{{asset('guru/vendor/fontawesome-free/css/all.min.css')}}" rel="stylesheet" type="text/css">
...
<body id="page-top">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/daftar-admin">Admin</a>
                        <a class="collapse-item" href="/daftar-panitia">Panitia</a>
                        <a class="collapse-item" href="/daftar-siswa">Pendaftar</a>
                    </div>
                </div>
            </li>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="{{asset('guru/img/undraw_profile.svg')}}">
                            </a>
    ...
    <!-- Page level plugins -->
    <script src="{{asset('guru/vendor/chart.js/Chart.min.js')}}"></script>
