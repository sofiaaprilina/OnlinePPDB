...
@section('title', 'Tambah Tampilan')

@section('content')
<div class="row">
    <div class="col-lg-12">
        <h2>Tambah Tampilan</h2>
    ...
    @csrf
     ...
     <div class="row justify-content-center">
        <div class="card shadow col-15 col-md-12 col-md-12">
            <div class="card-body">
                <div class="col-xs-12 col-sm-12 col-md-12" id="no" style='display:none;'>
                    <div class="form-group">
                        <strong>No</strong>
                        <input type="text" name="no" class="form-control" onkeyup="this.value=this.value.replace(/[^\d]/,'')" placeholder="urutan nomor...">
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="link" class="form-control" placeholder="Masukkan link di sini...">
                    </div>
                </div>
